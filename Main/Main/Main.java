...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        CreditAccount cred=new CreditAccount(BDO,"1234","averine","brar","brar@gmail.com","0987");
        BDO.addNewAccount(cred);
        SavingsAccount savingsAccount=new SavingsAccount(BDO, "1112","averine","soph","soph@gmail.com","12324",10000);
